...
public class ConferenceMemberView extends RelativeLayout {
    ...
    public ConferenceMemberView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.widget_conference_view, this);
        init();
    }
    ...
    public void setPubOrSub(boolean activate) {
        ...
        if (isPubOrSub) {
            ...
            activateView.setBackgroundResource(R.color.vm_green_54);
        } else {
            avatarView.setVisibility(View.VISIBLE);
            activateView.setBackgroundResource(R.color.vm_red_54);
        }
    }
}
